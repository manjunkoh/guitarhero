...
int PlaySong(song_t song) {
    static int i = 0;
    //for (i=0; i<song.note_count; i++)
    int noteFinished = PlayNote(song.notes[i]);
    if(noteFinished == 1)
    {
        i++;
    }

    if (i >= song.note_count)
            {
                i = 0;
                return 1;
            }
...
void InitSongList() {
    ...
    enter_sandman.notes[0].note_length = 20*DURATION;
    ...
    hokie_fight.notes[0].note_length = 20*DURATION;
    ...
    GoT_song.notes[i].note_name = note_silent;
    GoT_song.notes[i].note_length = 20*DURATION;
    i++;

    GoT_song.notes[i].note_name = note_g4;
    GoT_song.notes[i].note_length = 6*DURATION;
    i++;

    GoT_song.notes[i].note_name = note_c4;
    GoT_song.notes[i].note_length = 4*DURATION;
    i++;

    GoT_song.notes[i].note_name = note_d4;
    GoT_song.notes[i].note_length = 3*DURATION;
    i++;

    GoT_song.notes[i].note_name = note_f4;
    GoT_song.notes[i].note_length = 3*DURATION;
    i++;
    ...
    GoT_song.notes[i].note_name = note_c4;
    GoT_song.notes[i].note_length = 2*DURATION;
    i++;
    ...
    GoT_song.notes[i].note_name = note_e4;
    GoT_song.notes[i].note_length = 3*DURATION;
    i++;
    ...
    GoT_song.notes[i].note_name = note_d4;
    GoT_song.notes[i].note_length = 5*DURATION;
    i++;

    GoT_song.notes[i].note_name = note_silent;
    GoT_song.notes[i].note_length = 40*DURATION;
    i++;

    GoT_song.note_count = i;
