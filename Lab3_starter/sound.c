...
int PlayNote(song_note_t songNote) {
...
if(stuff)
{
    ...
    pwmConfig.clockSourceDivider = TIMER_A_CLOCKSOURCE_DIVIDER_7;
    ...
    pwmConfig.timerPeriod = SYSTEMCLOCK/TIMER_A_CLOCKSOURCE_DIVIDER_7/toneFreq[songNote.note_name];
    ...
    pwmConfig.dutyCycle   = 0.5*pwmConfig.timerPeriod;
